...
public class RegistrationDto {
    ...
    public RegistrationDto(long regId, LocalDate regDate, double proAmount, long intkId, long stdntId) {
        this.regId = regId;
    ...
    public RegistrationDto(long regId, LocalDate regDate, String proName, String studentName) {
        this.regId = regId;
        this.regDate = regDate;
